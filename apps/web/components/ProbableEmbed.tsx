...
export default function ProbableEmbed({ marketId, theme = "dark", apiKey = "sk_test_4Jn8Wz1c", onTrade }: ProbableEmbedProps) {
  ...
  return (
    <div style={{
      ...
      color: isDark ? "#ffffff" : "#120F24",
      border: "1px solid rgba(130, 0, 255, 0.09)",
      borderRadius: "16px",
      padding: "20px",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px" }}>
        <span style={{ font: "600 10px 'JetBrains Mono', monospace", color: isDark ? "#B3A8D9" : "#625E77", letterSpacing: "1px" }}>
          &lt;probable-embed&gt;
        </span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "20px" }}>
        <div style={{
          background: isDark ? "#1A1230" : "#F8F8FA",
          border: "1px solid rgba(130, 0, 255, 0.08)",
          borderRadius: "12px",
          padding: "12px",
          textAlign: "center",
          transition: "background 0.3s, border-color 0.3s",
          borderColor: flashType === "up" ? "#17B877" : flashType === "down" ? "#FF5C23" : "rgba(130, 0, 255, 0.08)"
        }}>
        ...
        <div style={{
          ...
          textAlign: "center",
          transition: "background 0.3s, border-color 0.3s",
          borderColor: flashType === "down" ? "#17B877" : flashType === "up" ? "#FF5C23" : "rgba(130, 0, 255, 0.08)"
        }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        <div style={{ display: "flex", alignItems: "center", background: isDark ? "#1A1230" : "#F8F8FA", borderRadius: "10px", padding: "4px 10px", border: "1px solid rgba(130,0,255,.1)" }}>
          <span style={{ font: "600 13px 'JetBrains Mono', monospace", color: isDark ? "#B3A8D9" : "#625E77", marginRight: "8px" }}>$</span>
          <input 
            type="number" 
            value={amount}
          ...
          />
          <span style={{ font: "500 11px 'JetBrains Mono', monospace", color: "#9490A8" }}>USDC</span>
        </div>
      ...
      {message && (
        <div style={{ 
          ...
          fontSize: "12px", 
          textAlign: "center", 
          color: message.startsWith("Success") ? "#17B877" : "#FF5C23",
